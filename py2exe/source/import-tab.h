...
#define PyGILState_Ensure ((PyGILState_STATE(*)(void))imports[32].proc)
#define PyGILState_Release ((void(*)(PyGILState_STATE))imports[33].proc)
#define PySys_SetObject ((void(*)(char *, PyObject *))imports[34].proc)
#define PySys_GetObject ((PyObject *(*)(char *))imports[35].proc)
#define PyString_FromString ((PyObject *(*)(char *))imports[36].proc)
#define Py_FdIsInteractive ((int(*)(FILE *, char *))imports[37].proc)
#define PyRun_InteractiveLoop ((int(*)(FILE *, char *))imports[38].proc)
#define PySys_SetArgv ((void(*)(int, char **))imports[39].proc)
#define PyImport_AddModule ((PyObject *(*)(char *))imports[40].proc)
#define PyModule_GetDict ((PyObject *(*)(PyObject *))imports[41].proc)
#define PySequence_Length ((int(*)(PyObject *))imports[42].proc)
#define PySequence_GetItem ((PyObject *(*)(PyObject *, int))imports[43].proc)
#define PyEval_EvalCode ((PyObject *(*)(PyCodeObject *, PyObject *, PyObject *))imports[44].proc)
#define PyErr_Print ((void(*)(void))imports[45].proc)
#define PyBool_FromLong ((PyObject *(*)(long))imports[46].proc)
#define Py_VerboseFlag (*(int(*))imports[47].proc)
#define Py_NoSiteFlag (*(int(*))imports[48].proc)
#define Py_OptimizeFlag (*(int(*))imports[49].proc)
